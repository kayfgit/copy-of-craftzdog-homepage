  ...
  return (
    <div className="text-black dark:text-white w-full h-45 flex justify-start items-center flex-col">
      ...
      <Link href="https://www.devas.life/">
        <button className="text-white dark:text-black duration-200 cursor-pointer hover:bg-[#24706e] hover:dark:bg-[#4fd1c5] rounded-lg bg-[#319795] dark:bg-[#81e6d9] font-semibold px-4 py-2 flex gap-3 mt-2">
