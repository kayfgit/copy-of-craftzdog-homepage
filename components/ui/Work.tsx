  ...
  return (
    <div className="text-black dark:text-white w-full h-full flex justify-start items-center flex-col">
      ...
      <Link href="https://www.craftz.dog/works">
        <button className="dark:text-black text-white duration-200 cursor-pointer hover:bg-[#81e6f9] rounded-lg bg-[#319795] dark:bg-[#81e6d9] font-bold px-4 py-2 flex gap-3 mt-2">
